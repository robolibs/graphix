...
namespace graphix::factor {
    ...
    GaussNewtonOptimizer::GaussNewtonOptimizer(const Parameters &params) : params_(params) {}
    double GaussNewtonOptimizer::compute_error(const Graph<NonlinearFactor> &graph, const Values &values) const {
    ...
    void GaussNewtonOptimizer::build_linear_system(const Graph<NonlinearFactor> &graph, const Values &values,
                                                   Matrix &JtJ, std::vector<double> &Jtb,
    ...
    GaussNewtonOptimizer::Result GaussNewtonOptimizer::optimize(const Graph<NonlinearFactor> &graph,
